...
STI=((Ys*Yw))/(Y ̅w)
## CHAPTER THREE
## EVALUATION OF WHITE AND YELLOW DOUBLE HAPLOID HYBRIDS UNDER DROUGHT AND LOW NITROGEN STRESSES
## Introduction
## FOR DROUGHT
Maize growth and development depend on many environmental factors. Optimum environmental conditions favor crop improvement and thus, enhance smooth running of maize breeding program. Drought stress, one of the predominant occurring environmental stresses tampers with the physiological and biochemical functions of maize crop. It occurs when there is little or no water available in the soil for uptake by plants. This results in leaf senescence and a substantial decreased in photosynthates produced by the plants (Iseghohi et al., 2021). Drought has caused a serious threat to food security in Africa. It has resulted in poor flowering period of maize crop leading to disruption of fertilization, poor grain filling, reduction in kernel number, and overall yield loss. As a result, Smallholder farmers in some parts of East Africa have not been able to increase their production potential (Sserumaga et al., 2018). Reports have shown that drought stress has also affected the germination, emergence, seedling establishment, vegetative growth and development, as well as the reproductive growth of the maize crop (Liu and Qin, 2021). Research studies posit that some maize genotypes that are found adaptive to multi-location environments could be a good source of tolerance to drought stress (Iseghohi et al., 2021). Other findings also explain that developing resilient varieties in breeding programme that are resistance and tolerance to drought stress could help to solve drought challenges encountered by smallholder farmers. Reports revealed that Conventional breeding strategies over the years have failed to develop maize varieties that are tolerant to drought stress. However, there have been some success stories that molecular breeding systems which include transgenic, genome-wide marker assisted selection, and gene editing technologies have provided more accurate information and approaches for the development of traits and new varieties that are tolerant to drought stress (Liu and Qin, 2021). Similar studies also report that adopting double-haploid technology makes it easy for quick development of drought-tolerant lines. This technology makes it possible to develop inbred lines in one or two generations compared with that of classical pedigree methods. Thus, it enables the maize breeder to develop hybrids from double-haploid lines that are tolerance to drought. These hybrids give good produce for smallholder farmers (Sserumaga et al., 2018). Therefore, the need of assessing white and yellow haploid hybrids under drought stress will be of prime importance to ascertain findings of this research study. 
## FOR LOW NITROGEN
Nitrogen plays essential role in the physiological processes of plants such as photosynthesis, and synthesis of protein. It is one of the major nutrient elements that is highly recommended by smallholder famers in the sub-Saharan Africa to be applied to their fields. Research Studies have proved that nitrogen is a good source of plant nutrient necessary for vegetative growth and development of crops in the field (Ertiro et al., 2020). 
Low nitrogen content in soils is a serious threat to food security issues in Africa. It decreases the maize yield to about 50% losses in the production process, leading to famine in many local areas in sub-Saharan Africa. It takes some efforts by the farmer to replenish the nutrient loss in the soil (Talabi et al., 2017). Research studies revealed that the decrease in nitrogen content in soils does not only have a negative impact on the yield and productivity of maize but also makes the livelihoods of farmers miserable. Application of nitrogen fertilizers and other forms of inorganic fertilizers to soils deficient in nitrogen is reported to be an appropriate intervention that could be adopted to restore back the loss of nitrogen to the soil. Restoration of nitrogen loss to the soils promotes proper growth of plants, good seedlings establishment, and crop improvement (Oleyede-Kamiyo et al., 2021). Farmers over the past years have not shown much interest in applying fertilizers to their fields. Fertilizers are expensive and thus, farmers are not able to purchase with the little income they have. Some farmers deliberately do not include cost of fertilizers on their budget plan when they begin the production process. Recent report has revealed that this is one among many reasons why most smallholder farmers find it difficult to increase their utmost production potential (Pasley et al., 2020). 
Studies posit that developing maize varieties and cultivars that are tolerant to low soil nitrogen is an effective method that could be adopted to access the performance of maize crops cultivated under low nitrogen soils and ensure economic management by farmers (Oleyede-Kamiyo et al., 2021). Another intervention that could also be used to solve the problems of crop failure cultivated under low nitrogen soils is the use of selective germplasm. Maize germplasm that have been targeted to be good source of genetic material can be screened for agronomic and physiological performance under low nitrogen stress conditions. Possible maize genotypes that are tolerant to low nitrogen could be obtained to develop tolerant hybrids that would perform very well for the desired effect (Riache et al., 2021).  Therefore, evaluating white and yellow double haploid hybrids under low nitrogen soils is of significant importance to find answers to questions in this research study.


## Materials and methods
## Plant material
A collection of white DH lines developed from three (3) populations was used for this study. The collection was assembled to identify drought tolerant and low nitrogen lines. Information about the lines, their pedigrees and their characteristics is presented in the table below. For the purpose of drought and low nitrogen screening, 36 DH lines were selected from each population and crossed to two testers of heterotic group A, CML545 and B, CML571 to produce single crossed hybrids. The testers are (chateristics of the testers). 
## For drought
Experimental design and management
Trials were conducted in three locations, two in Ghana (Bontanga and Golinga) and one in Senegal (Bambeye). 
Seventy single crossed hybrids were evaluated under two conditions: non-water stress, water stress, normal irrigation was done for the well-watered field and in opposite, water stress was imposed at the reproductive stages of the inbreds by stopping the irrigation after 3 weeks before anthesis and 4 weeks after anthesis. Grain yield was determined for both conditions, no water stress and water stress. 
Phenotyping
## For drought:
All the data that were used for selection under drought experiment were collected by following the CIMMYT phenotyping manual for drought tolerance. The data collected are:
	## days to 50% anthesis and silking :
it was monitored per day from the emergence of the first tassel in the field until all the inbred in the trial have finished anthesis and silking. They were recorded when at least 50% of the plant had the male flowers (anthesis) and 50% of the plant had developed female flowers (silking). The genotypes that were selected were those that do not had significant changes in both anthesis and silking under drought compared to normal condition.
	## Anthesis-silking interval (ASI) was determined. 
ASI is the difference between the number of days to anthesis and the number of days to silking. It is the synchrony between male and female flowering. It was calculated as the difference between anthesis date (AD) and silking date (SD): ASI = SD – AD.
	## Grain yield :
It was given by measuring the grain weight per plot using a suitable digital balance. 
	## Plant and ear height :
They were recorded after anthesis and before harvesting. For the height, five plants were selected randomly and were measured from the soil surface to the base of the tassel. The heights of these selected plants were recorded by measuring the base of the plants to the upper nod of the ears. The genotypes that were selected were those with no much differences in plant and ear heights in drought and normal conditions. 
	## Leave per plant and leaf area (LA)
The leave per plant was taken by counting the number of leave per plant. Five plants was selected randomly for the measurement. The leaf area of each plant was recorded by using the formula of Mokhtarpour et al. (2010):  
LA= length of the leave × width of the leave × 0.75 (shape factor)
	## ear per plant (EPP) : 
the ears represent the key trait because it determines the yield under both drought and normal condition. Ears per plant were determinate just after harvest. The total number of ears harvested was counted in each plot. Any ear having at least one grain was considered. After the collection of the ears, the number of plants per plot was calculated using the formula:
## EPP=(number ears per plot)/(total number of plants per plot)
The determination of this EPP is to evaluate the stress-induced barrenness in plant.
## Barrenness= 1-EPP.
## ear aspect :
it was scored by using the scale of author going from 1 to 5. The rate one means that the ear is well filled, clean, large, and uniform. The rate 5 was be given to the ears that are Rotten, variable, partially filled and small. 
## ear weight per plot (kg)
it was recorded in term of ear weight per plot just after harvest. The ear weight per plot was measured by using a balance 
## root and stem lodging :
the root and the stem lodging was recorded between the physiological maturity and the harvest time. It will be done by counting the number of plants that had the root or the stem logded over the total number of plants. Genotypes without plant lodging under drought stress was selected.
## leaf senescence: 
the leave senescence show the avoidance or the tolerance of the plant to drought stress It was collected two weeks after flowering on a weekly basis. A scale from 0 to 10 was used to rate the leave senescence. The percentage of the total leave area that is dead was divided by 10. When there is no dead leaf the rate is 0; the score 1 means 10% of the leaf area is dead, 2=20% dead leaf area; 3=30%; 4=40% dead leaf area 5=50% dead leaf area; 6= 60% dead leaf area; 7=70% dead leaf area; 8=80% dead leaf area; 9= 90% dead leaf area; 10= all leaf area is dead. After dead leaf scoring the genotypes with delayed senescence will be selected.
## Number of plants : 
The number of plant is important for yield and also the calculation of plant lodging and ear per plant. It was be recorded between the physiological maturity and harvest by counting the total number of plants in a plot including both lodged and un-lodged plants. 
## Grain moisture content :
In most of the time grain moisture is high at the time of harvest. Grain moisture content is recorded to calculate final grain yield having a uniform grain moisture content. Just after harvesting and calculation of grain yield base on ear weight per plot, moisture content was recorded. Kernels from different ears in a plot were bulk per sample. A grain moisture meter were used to record the moisture content for each plot.
Some secondary traits were also collected :
## the day to seedling emergence, 
it was taken from the third day after planting date until 50% of all seedling emerge above the surface of the soil. The number of the visible coleoptiles above the soil surface was counted and the total number of days was calculated until it reached 50% of emergence. The genotypes with faster seedling emergence were selected.
## the seedling vigour :
This trait will show the performance the genotype under both nitrogen and drought stress. It was collected two and three weeks after seedling emergence by using a scale of 1-5. When it is low, it received the rate one. High seedling vigor received the rate 5.
## the number of grains per ear,
it is important to measure it because all the cobs may not be fully filled because of kernel abortion due to the stress at the flowering stage. Five ears was selected from each plot for this measure after harvest. The total number of grain on each ear from each plot was counted and the average number of grains per ear was divided by five.
## the physiological maturity,
It was taken 3 to 6 weeks after anthesis in all the plots when the husk cover leave on the ear was dried. 
## the weight of 100 grains will be collected. 
It was recorded after harvesting by shelling an equal number of grains from some ears to get 100 grains sample per plot and measured it using an adequate balance.
## The stress susceptibility index (SSI) according to Fischer & Maurer, (1978) was determined.
It was done following the formula: SSI = [1-Yp/Ys]/SI
SI= stress intensity. SI = [1- /MYs/MYp].
## The mean productivity (MP) and tolerance index (TOL) were calculated by using Rosielle & Hamblin, 1981 formula.
PM= (Ys+Yw)/2.
TOL =Yw-Ys
The stress tolerance index (STI) was done according to Fernandez, 1992 formula
STI=((Ys*Yw))/(Y ̅w)
## For the low nitrogen
For this trial, a soil analysis was done in each location to determine the amount of nitrogen before planting. The data are shown in the table below
The same collected data following the protocol of CIMMYT for the drought trial were taken under the nitrogen trial. In addition to it, the leaf chlorophyll contain was taken.
## the chlorophyll content 
it was randomly determined in 5 randomly collected plants from each plot. Two measurements were done for each selected plant on the ear leaf one week after silking. A portable Minolta chlorophyll meter (SPAD) was use for the measurement.
## Soil moisture content 
The soil moisture content was measured at 10, 20, 30, 40, 60, 100 cm soils depth two times in a week by using a Delta-T soil moisture probe.
